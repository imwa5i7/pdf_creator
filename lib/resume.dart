...
Future<pw.PageTheme> _myPageTheme(PdfPageFormat format) async {
  final bgShape = await rootBundle.loadString('assets/svg/resume.svg');
  ...
  return pw.PageTheme(
    ...
    theme: pw.ThemeData.withFont(
      base: pw.Font.ttf(await rootBundle.load('assets/fonts/open-sans.ttf')),
      bold:
          pw.Font.ttf(await rootBundle.load('assets/fonts/open-sans-bold.ttf')),
